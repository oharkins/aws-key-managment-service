...
export class AdminService {
    ...
    public addKey(serviceId: string): Observable<any>  {
        const url = `${platformApiUrl}/services/${serviceId}/keys`;
        return this.http.post<any>(url,{});
    }
    public rotateKey(serviceId: string,keyId: string): Observable<any>  {
        const url = `${platformApiUrl}/services/${serviceId}/keys/${keyId}/rotate`;
        return this.http.post<any>(url,{});
    }
    public deleteKey(serviceId: string,keyId: string): Observable<any>  {
